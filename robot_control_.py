...
# joint_states.blosc2 から初期姿勢を読み込む
import blosc2
...
with torch.no_grad():
    for step in range(NUM_STEPS):
        ...
        # image_feature と joint 結合 & action の予測 
        ...
        # ロボットに送信
        replay.send(action=action_prediction_denorm, fps=FPS)
...
margin_top_bottom = 30     # 上下余白
margin_sides = 20  # 左右余白
...
joints_np = joints_tensor.numpy()  #フォロワーの関節角度,6)
